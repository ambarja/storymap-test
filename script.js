...
const references = ` 
  <div class='reference'>
   ...
   <ul style="padding-bottom: 10px; margin-top: 0px;"><li><p class="reference">Strachota, S. (2020). Generalizaing in teh context of an early algebra intervention. Infancia y aprendizaje, 43(2), 347-394.</p></li></ul>
  </div>
`
